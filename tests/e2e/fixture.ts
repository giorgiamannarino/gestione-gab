...
export function exampleBackup() {
  ...
  const recurring = [
    ...
    { id: 'subs', name: 'Abbonamenti', kind: 'allocation', amount: 0, amountFromDebits: true, fromPocketId: 'main', toPocketId: 'subs', active: true, order: 5 },
    { id: 'love', name: 'Coppia', kind: 'allocation', amount: 5000, fromPocketId: 'main', toPocketId: 'love', active: true, order: 6 },
    { id: 'home', name: 'Casa', kind: 'allocation', amount: 30000, fromPocketId: 'main', toPocketId: 'home', active: true, order: 7 },
    { id: 'fun', name: 'Svago', kind: 'allocation', amount: 40000, fromPocketId: 'main', toPocketId: 'fun', active: true, order: 8 },
    { id: 'car', name: 'Auto', kind: 'allocation', amount: 15000, fromPocketId: 'main', toPocketId: 'car', active: true, order: 9 },
