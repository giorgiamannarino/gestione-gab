...
export function demoData(todayDate: ISODate = todayFn()): AppData {
  ...
  const recurring: Recurring[] = [
    ...
    { id: 'abb', name: 'Abbonamenti', kind: 'allocation', amount: 0, amountFromDebits: true, fromPocketId: 'isp', toPocketId: 'abb', active: true, order: 5 },
    { id: 'coppia', name: 'Coppia', kind: 'allocation', amount: 5000, fromPocketId: 'isp', toPocketId: 'coppia', active: true, order: 6 },
    { id: 'casa', name: 'Casa', kind: 'allocation', amount: 30000, fromPocketId: 'isp', toPocketId: 'casa', active: true, order: 7 },
    { id: 'svago', name: 'Svago', kind: 'allocation', amount: 40000, fromPocketId: 'isp', toPocketId: 'svago', active: true, order: 8 },
    { id: 'auto', name: 'Auto', kind: 'allocation', amount: 15000, fromPocketId: 'isp', toPocketId: 'auto', active: true, order: 9 },
