...
<div class="page">
  ...
  <details>
    ...
    <p><strong>Scadenze</strong> (Impostazioni → Spese fisse → Scadenze): per bollo, assicurazione, università… l'importo si divide tra gli stipendi che arrivano prima della scadenza. A ogni stipendio, fino all'ultimo prima del pagamento, la quota compare nella checklist del Piano sotto Scadenze. Di default si preleva dal conto dello stipendio e la quota si toglie da quanto puoi mettere da parte; se scegli un altro pocket da cui prelevare, la voce resta da spuntare ma non tocca lo stipendio; se il pocket dove accantoni ha già il suo spostamento fisso (es. Auto 150 €), la quota non è una voce a parte: lo spostamento diventa il più alto tra il budget del pocket e la somma delle scadenze, senza sommarli, e finite le scadenze torna al budget; se quello spostamento lo fai a mano dai Movimenti invece di spuntarlo, le quote delle scadenze si contano solo se il giroconto copre tutta la voce; se è di meno, la voce resta da completare e la spunta sposta solo quello che manca. Una voce fatta con un giroconto dai Movimenti si può togliere: il giroconto resta, ma per quella voce non conta. In fondo al Piano il riepilogo delle scadenze mostra per ognuna data, tempo che resta, quanto hai messo da parte e quanto manca; se uno stipendio salti la spunta, la parte mancante si spalma sugli stipendi successivi. Il pagamento compare in Da confermare dai 7 giorni prima e scala l'importo dal pocket dove hai accantonato; se è annuale passa all'anno dopo e l'accantonamento riparte.</p>
